...
public class Enemy9 extends Entity {
    ...
    public Enemy9(Vector2 posE, Vector2 directionE, int hpE) {
        super(TextureManager.ENEMY9, currentFrame, posE, directionE, col, row, hpE);
        this.hpE = hpE;

        TextureRegion[][] temp = TextureRegion.split(TextureManager.ENEMY9, TextureManager.ENEMY4.getWidth()/col, TextureManager.ENEMY4.getHeight()/row);
    ...
    public void addMoney() {
        GameScreen.money = GameScreen.money + 9;
    }
