...
public class Enemy2 extends Entity{
    ...
    public Enemy2(Vector2 posE, Vector2 directionE, int hpE) {
        super(TextureManager.ENEMY2, currentFrame, posE, directionE, col, row, hpE);
        this.hpE = hpE;

        TextureRegion[][] temp = TextureRegion.split(TextureManager.ENEMY2, TextureManager.ENEMY2.getWidth()/col, TextureManager.ENEMY2.getHeight()/row);
