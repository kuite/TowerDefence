...
public class Enemy6 extends Entity{
    ...
    public Enemy6(Vector2 posE, Vector2 directionE, int hpE) {
        super(TextureManager.ENEMY6, currentFrame, posE, directionE, col, row, hpE);
        this.hpE = hpE;

        TextureRegion[][] temp = TextureRegion.split(TextureManager.ENEMY6, TextureManager.ENEMY4.getWidth()/col, TextureManager.ENEMY4.getHeight()/row);
    ...
    public void addMoney() {
        GameScreen.money = GameScreen.money + 5;
    }
