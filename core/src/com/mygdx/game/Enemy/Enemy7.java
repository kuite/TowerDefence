...
public class Enemy7 extends Entity{
    ...
    public Enemy7(Vector2 posE, Vector2 directionE, int hpE) {
        super(TextureManager.ENEMY7, currentFrame, posE, directionE, col, row, hpE);
        this.hpE = hpE;

        TextureRegion[][] temp = TextureRegion.split(TextureManager.ENEMY7, TextureManager.ENEMY4.getWidth()/col, TextureManager.ENEMY4.getHeight()/row);
    ...
    public void addMoney() {
        GameScreen.money = GameScreen.money + 6;
    }
