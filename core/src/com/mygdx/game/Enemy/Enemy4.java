...
public class Enemy4 extends Entity{
    ...
    public Enemy4(Vector2 posE, Vector2 directionE, int hpE) {
        super(TextureManager.ENEMY4, currentFrame, posE, directionE, col, row, hpE);
        this.hpE = hpE;

        TextureRegion[][] temp = TextureRegion.split(TextureManager.ENEMY4, TextureManager.ENEMY4.getWidth()/col, TextureManager.ENEMY4.getHeight()/row);
