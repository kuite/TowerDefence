...
public class Enemy1 extends Entity{
    ...
    public Enemy1(Vector2 posE, Vector2 directionE, int hpE) {
        super(TextureManager.ENEMY1, currentFrame, posE, directionE, col, row, hpE);
        this.hpE = hpE;

        TextureRegion[][] temp = TextureRegion.split(TextureManager.ENEMY1, TextureManager.ENEMY1.getWidth()/col, TextureManager.ENEMY1.getHeight()/row);
