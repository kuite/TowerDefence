...
public class Enemy8 extends Entity{
    ...
    public Enemy8(Vector2 posE, Vector2 directionE, int hpE) {
        super(TextureManager.ENEMY8, currentFrame, posE, directionE, col, row, hpE);
        this.hpE = hpE;

        TextureRegion[][] temp = TextureRegion.split(TextureManager.ENEMY8, TextureManager.ENEMY4.getWidth()/col, TextureManager.ENEMY4.getHeight()/row);
    ...
    public void addMoney() {
        GameScreen.money = GameScreen.money + 7;
    }
