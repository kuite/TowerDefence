...
public class Enemy12 extends Entity {
    ...
    public Enemy12(Vector2 posE, Vector2 directionE, int hpE) {
        super(TextureManager.ENEMY12, currentFrame, posE, directionE, col, row, hpE);
        this.hpE = hpE;

        TextureRegion[][] temp = TextureRegion.split(TextureManager.ENEMY12, TextureManager.ENEMY12.getWidth()/col, TextureManager.ENEMY12.getHeight()/row);
    ...
    public void addMoney() {
        GameScreen.money = GameScreen.money + 20;
    }
