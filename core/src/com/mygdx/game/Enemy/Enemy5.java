...
public class Enemy5 extends Entity{
    ...
    public Enemy5(Vector2 posE, Vector2 directionE, int hpE) {
        super(TextureManager.ENEMY5, currentFrame, posE, directionE, col, row, hpE);
        this.hpE = hpE;

        TextureRegion[][] temp = TextureRegion.split(TextureManager.ENEMY5, TextureManager.ENEMY4.getWidth()/col, TextureManager.ENEMY4.getHeight()/row);
    ...
    public void addMoney() {
        GameScreen.money = GameScreen.money + 4;
    }
