...
public class Enemy13 extends Entity{
    ...
    public Enemy13(Vector2 posE, Vector2 directionE, int hpE) {
        super(TextureManager.ENEMY13, currentFrame, posE, directionE, col, row, hpE);
        this.hpE = hpE;

        TextureRegion[][] temp = TextureRegion.split(TextureManager.ENEMY13, TextureManager.ENEMY13.getWidth()/col, TextureManager.ENEMY13.getHeight()/row);
    ...
    public void addMoney() {
        GameScreen.money = GameScreen.money + 2;
    }
}
