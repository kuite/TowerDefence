...
public class Enemy10 extends Entity {
    ...
    public Enemy10(Vector2 posE, Vector2 directionE, int hpE) {
        super(TextureManager.ENEMY10, currentFrame, posE, directionE, col, row, hpE);
        this.hpE = hpE;

        TextureRegion[][] temp = TextureRegion.split(TextureManager.ENEMY10, TextureManager.ENEMY4.getWidth()/col, TextureManager.ENEMY4.getHeight()/row);
    ...
    public void addMoney() {
        GameScreen.money = GameScreen.money + 12;
    }
